...
describe('rates test', () => {
    ...
    it('getShortestPathRate from eos token to eos token (convert)', async () => {
        ...
        const spyGetShortestPath = jest
            .spyOn(sdk, 'getShortestPath')
            .mockImplementationOnce(() => Promise.resolve([
        ...
        expect(spyGetShortestPath).toHaveBeenCalledTimes(1);
    });

    it('getShortestPathRate from eos token to eos token (buy)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({  }))
            .mockImplementationOnce(() => ({  }))
    ...
    it('getShortestPathRate from eos token to eos token (sell)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }))
    ...
    it('getShortestPathRate from eos token to eos token (buy / multi-token)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({  }))
            .mockImplementationOnce(() => ({  }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' }, isMultiConverter: true }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }));
    ...
    it('getShortestPathRate from eos token to eos token (sell / multi-token)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' }, isMultiConverter: true }))
    ...
    it('getShortestPathRate from eos token to ethereum token', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({ }))
            .mockImplementationOnce(() => ({ }))
    ...
    it('getShortestPathRate from ethereum token to eos token', async () => {
        const spyGetDecimals = jest
            .spyOn(ethereum, 'getDecimals')
            .mockImplementationOnce(() => Promise.resolve('18'))
            .mockImplementationOnce(() => Promise.resolve('18'));
    ...
    it('getShortestPathRate from ethereum token to ethereum token', async () => {
        const spyGetDecimals = jest
            .spyOn(ethereum, 'getDecimals')
            .mockImplementationOnce(() => Promise.resolve('18'))
            .mockImplementationOnce(() => Promise.resolve('18'));
    ...
    it('getCheapestPathRate from eos token to eos token (buy / multi-token)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({  }))
            .mockImplementationOnce(() => ({  }))
    ...
    it('getCheapestPathRate from eos token to eos token (sell / multi-token)', async () => {
        const spyGetSmartTokens = jest
            .spyOn(eos, 'getSmartTokens')
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' } }))
            .mockImplementationOnce(() => ({ AAABBB: { AAABBB: 'aaabbbaaabbb' }, isMultiConverter: true }))
