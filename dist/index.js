...
var index_2 = require("./blockchains/eos/index");
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = sdk;
                        return [4 /*yield*/, index_1.Ethereum.create(settings.ethereumNodeEndpoint)];
                    case 1:
                        _a.ethereum = _c.sent();
                        _c.label = 2;
                    case 2:
                        ...
                        _b = sdk;
                        return [4 /*yield*/, index_2.EOS.create(settings.eosNodeEndpoint)];
                    case 3:
                        _b.eos = _c.sent();
                        _c.label = 4;
    ...
    SDK.destroy = function (sdk) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!sdk.ethereum) return [3 /*break*/, 2];
                        return [4 /*yield*/, index_1.Ethereum.destroy(sdk.ethereum)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!sdk.eos) return [3 /*break*/, 4];
                        return [4 /*yield*/, index_2.EOS.destroy(sdk.eos)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    SDK.prototype.refresh = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.ethereum) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.ethereum.refresh()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!this.eos) return [3 /*break*/, 4];
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _a = pathType(sourceToken.blockchainType, targetToken.blockchainType);
                    switch (_a) {
                        case pathType('ethereum', 'ethereum'): return [3 /*break*/, 1];
                        case pathType('ethereum', 'eos'): return [3 /*break*/, 3];
                        case pathType('eos', 'ethereum'): return [3 /*break*/, 6];
                        case pathType('eos', 'eos'): return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 1: return [4 /*yield*/, sdk.ethereum.getAllPathsAndRates(sourceToken.blockchainId, targetToken.blockchainId, amount)];
                case 2:
                ...
                case 3: return [4 /*yield*/, sdk.ethereum.getAllPathsAndRates(sourceToken.blockchainId, sdk.ethereum.getAnchorToken(), amount)];
                case 4:
                ...
                case 6: return [4 /*yield*/, sdk.eos.getPath(sourceToken, sdk.eos.getAnchorToken())];
                case 7:
                    eosPath = _e.sent();
                ...
                case 9: return [4 /*yield*/, sdk.eos.getPath(sourceToken, targetToken)];
                case 10:
                    eosPath = _e.sent();
